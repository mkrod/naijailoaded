import React, { type FC, memo, type ReactNode, useCallback, useEffect, useRef, useState } from 'react'
...
const VideoPlayer: FC<Props> = ({ /*thumbnail,*/ data, /*totalTrack = 1, setTrack,*/ activeTrack = 0, }): ReactNode => {
